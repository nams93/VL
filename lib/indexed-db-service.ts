...
export const addToStore = <T>(storeName: string, data: T): Promise<T> => {
  return new Promise((resolve, reject) => {
    initDatabase()
      .then(db => {
...
export const updateInStore = <T>(storeName: string, data: T): Promise<T> => {
  return new Promise((resolve, reject) => {
    initDatabase()
      .then(db => {
        const transaction = db.transaction(storeName, 'readwrite');
...
export const getFromStore = <T>(storeName: string, id: string): Promise<T | null> => {
  return new Promise((resolve, reject) => {
    initDatabase()
      .then(db => {
...
export const getByIndex = <T>(storeName: string, indexName: string, value: any): Promise<T[]> => {
  return new Promise((resolve, reject) => {
    initDatabase()
      .then(db => {
        const transaction = db.transaction(storeName, 'readonly');
